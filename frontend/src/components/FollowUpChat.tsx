  ...
  async function ask(question: string) {
    ...
    try {
      const resp = await fetch(`${API_URL}/api/ask`, {
        ...
        body: JSON.stringify({ anomalies, question: q, briefing: briefing ?? {} }),
        signal: abort.signal,
      });
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-xs font-semibold tracking-wider uppercase" style={{ color: "#94a3b8" }}>
          Ask the SOC AI
        </h2>
        <span
      ...
      {messages.length > 0 && (
        <div
          className="flex flex-col gap-3 mb-3 max-h-[260px] overflow-y-auto pr-1"
            ...
            {messages.map((msg, i) => (
              ...
              >
                ...
                <div style={{
                  ...
                  {msg.role === "assistant"
                    ? <Bot className="w-3 h-3" style={{ color: "#818cf8" }} />
        ...
        <button
          ...
          style={{
            ...
            background: input.trim() && !streaming
              ...
              : "rgba(255,255,255,0.04)",
            color: input.trim() && !streaming ? "#818cf8" : "#334155",
