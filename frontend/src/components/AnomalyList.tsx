...
export function AnomalyList({ anomalies, onIPClick }: AnomalyListProps) {
  return (
    <motion.div
    ...
    >
      ...
      >
        <ShieldAlert className="w-4 h-4" style={{ color: "#818cf8" }} />
        <h2
        ...
        {anomalies.map((a, i) => {
          ...
          return (
            ...
            >
              ...
              <div className="mt-2.5 space-y-1" style={{ color: "#94a3b8" }}>
                {a.parsed_log.ip && (
                  <div className="flex items-center gap-2 flex-wrap">
                    <button
                      ...
                      className="text-xs font-mono opacity-75 hover:opacity-100 transition-opacity underline decoration-dotted"
                      style={{
                        background: "none",
                        border: "none",
                        cursor: "pointer",
                ...
                <p
                  className="text-xs font-mono truncate mt-1.5 px-2.5 py-1.5 rounded-lg"
                  style={{
                    color: "#94a3b8",
              ...
              >
                <span className="font-bold" style={{ color: "#818cf8" }}>MITRE</span>
